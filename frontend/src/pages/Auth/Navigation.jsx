...
return(
    <div className="fixed bottom-10 left-120 transform translate-x-1/2 translate-y-1/2
    z-50 bg-[#0f0f0f] border w-[30%] px-16 mb-8 rounded">
        <section className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <Link to="/movies" className="flex items-center transition-transform transform hover:translate-x-2 ml-4">
